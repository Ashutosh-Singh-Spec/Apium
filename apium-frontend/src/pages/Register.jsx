      ...
      <div className='w-[80vh] h-[80vh] flex items-center flex-col mb-2'>
        <form onSubmit={handleSubmit} className='w-99 h-65 mt-5 flex justify-center items-center flex-col'>
          <div
            ...
            onClick={() => document.getElementById("usernameInput").focus()}
          >
            <label className="text-xs font-normal text-gray-600">USERNAME</label>
            <input
              id="usernameInput"
              name="username"
              type="text"
        ...
        <div className='text-sm font-semibold w-full flex justify-center items-center my-2'>
          OR
        </div>
        ...
        <div className='flex gap-1 text-xs mt-2'>
          ...
          <Link
            to="/login"
          >
            <p className='text-red-600 text-xs'>Log in</p>
          </Link>
        </div>
      </div>
    </div>
